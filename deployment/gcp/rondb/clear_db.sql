...
DROP TABLE key_value_state;
DROP TABLE key_value_state_committed;
DROP TABLE key_value_state_snapshot;
DROP TABLE list_key_value_state_snapshot;
DROP TABLE list_state_attrib;
DROP TABLE list_state_attrib_committed;
DROP TABLE list_value_state;
DROP TABLE list_value_state_committed;
DROP TABLE map_key_value_state;
DROP TABLE map_key_value_state_committed;
DROP TABLE map_key_value_state_snapshot;
